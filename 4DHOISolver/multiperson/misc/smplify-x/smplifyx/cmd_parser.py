...
def parse_config(argv=None):
    ...
    parser.add_argument('--model_type', default='smpl', type=str,
                        ...
                        ' data.')
    parser.add_argument('--j_regressor_extra', default='data/J_regressor_extra.npy', type=str,
                        help='Path to extra joints regressor')
    parser.add_argument('--j_regressor_h36m', default='data/J_regressor_h36m.npy', type=str,
                        help='Path to extra joints regressor')
