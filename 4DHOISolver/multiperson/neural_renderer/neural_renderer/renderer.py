...
class Renderer(nn.Module):
    ...
    def visibility(self, vertices, faces, K=None, R=None, t=None, dist_coeffs=None, orig_size=None):
        ...
        face_visibility = nr.face_visibility(faces, self.image_size, near=self.near, far=self.far)
